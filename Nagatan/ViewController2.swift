...
class ViewController2: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        if height == 480 {
            ...
            label = UILabel(frame: CGRectMake(55, 130, 50, 50))
            ...
            myUIPicker.frame = CGRectMake(60,230,self.view.bounds.width-120, 250)
            label = UILabel(frame: CGRectMake(75, 130, 100, 50))
