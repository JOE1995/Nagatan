...
class SingleViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if height == 480 {
            ...
            randy = getRandomNumber(Min: 100, Max: 450)
            
            //iPhone5・5s・5c
        }else if height == 568 {
            randx = getRandomNumber(Min: 30, Max: 290)
            randy = getRandomNumber(Min: 100, Max: 508)
            
            //iPhone6
        }else if height == 667 {
            randx = getRandomNumber(Min: 30, Max: 345)
            randy = getRandomNumber(Min: 100, Max: 607)
            
            //iPhone6 Plus
        }else if height == 736 {
            randx = getRandomNumber(Min: 30, Max: 384)
            randy = getRandomNumber(Min: 100, Max: 676)
            
            //iPad
        }else if height == 1024 {
            randx = getRandomNumber(Min: 40, Max: 720)
            randy = getRandomNumber(Min: 200, Max: 960)
